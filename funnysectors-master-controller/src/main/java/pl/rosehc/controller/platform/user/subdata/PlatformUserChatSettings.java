...
public final class PlatformUserChatSettings {
  ...
  public PlatformUserChatSettingsSerializableWrapper wrap() {
    return new PlatformUserChatSettingsSerializableWrapper(this.global, this.itemShop, this.kills,
        this.deaths, this.cases, this.achievements, this.rewards, this.privateMessages);
  }
