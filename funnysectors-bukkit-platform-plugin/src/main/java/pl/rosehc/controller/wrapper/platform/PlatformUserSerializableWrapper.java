...
public final class PlatformUserSerializableWrapper {
  ...
  public PlatformUserSerializableWrapper(final UUID uniqueId, final UUID lastPrivateMessage,
      ...
      final String selectedDiscoEffectTypeName, final long rankExpirationTime,
      final long combatTime, final boolean firstJoin, final boolean vanish, final boolean god,
      final boolean discordRewardReceived) {
